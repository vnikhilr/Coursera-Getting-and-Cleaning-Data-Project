...
setwd("C:/Users/getti_000/Documents/Coursera Assignment Data")

## Download and unzip the dataset:
destfile <- "getdata_dataset.zip"
...
my_tidy_dataset <- data.frame(summarise_all(group_by(narrow_data, Subject, 
                                                     Activity_Name),mean))
